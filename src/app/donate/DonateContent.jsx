        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.04fr_0.96fr] items-stretch">
          <div className="flex flex-col justify-center py-12 lg:py-20 lg:pr-12 order-2 lg:order-1">
            ...
            <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.24 }}
              ...
              <a href="#give" className="inline-flex items-center gap-2 bg-yellow-500 text-black font-bold px-7 py-4 hover:brightness-95 transition-all">
                Support the work <ArrowRight size={17} />
              </a>
              <a href="#ledger" className="inline-flex items-center gap-2 border border-white/15 text-gray-200 font-semibold px-6 py-4 hover:border-yellow-500 hover:text-yellow-500 transition-colors">
                See the ledger
              </a>
            </motion.div>
          </div>
...
.btcpay-input-price::-webkit-outer-spin-button, .btcpay-input-price::-webkit-inner-spin-button { -webkit-appearance: none; margin: 0; }
      ...
      <section className="max-w-[1140px] mx-auto px-6 py-24 border-t border-white/[0.08] text-center">
        ...
        <motion.div {...fadeUp} className="flex flex-wrap gap-3 justify-center">
          ...
          <Link href="/subscribe" className="inline-flex items-center gap-2 border border-white/15 text-gray-200 font-semibold px-6 py-4 hover:border-yellow-500 hover:text-yellow-500 transition-colors">
            Subscribe free
          </Link>
        </motion.div>
      </section>
