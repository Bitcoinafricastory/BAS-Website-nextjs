...
import { computeReadingTime, deriveKeyTakeaways, getFaqs, addHeadingIds, extractHeadings, preventHyphenBreaks, normalizeNonBreakingSpaces } from '@/lib/article-content';
...
export default async function BlogPostPage({ params }) {
  ...
  const contentWithIds = preventHyphenBreaks(addHeadingIds(normalizeNonBreakingSpaces(post.content)));
