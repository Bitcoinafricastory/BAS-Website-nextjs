        ...
        {hasEpisodes ? (
          ...
          <div className="bg-[#0A0A0A] border border-white/5 rounded-2xl p-10 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <a href="https://youtube.com/@bitcoinafricastory" target="_blank" rel="noopener noreferrer" className="px-6 py-2.5 bg-yellow-500 text-black font-semibold rounded-lg hover:bg-yellow-400 transition-colors">
                Watch on YouTube
              </a>
              <Link href="/podcast" className="px-6 py-2.5 border border-yellow-500 text-yellow-500 font-semibold rounded-lg hover:bg-yellow-500 hover:text-black transition-colors">
                View the Podcast
              </Link>
            </div>
          </div>
