      ...
      <div>
        <form onSubmit={handleSubmit} className="flex gap-2 max-w-sm">
          ...
          <button
            type="submit"
            disabled={busy}
            className="flex-shrink-0 px-5 py-2.5 bg-yellow-500 text-black text-sm font-medium rounded-lg hover:bg-yellow-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {busy ? '…' : 'Subscribe'}
          </button>
        </form>
    ...
    <div className="bg-gradient-to-r from-yellow-500/10 to-yellow-600/5 border border-yellow-500/30 rounded-2xl p-8 md:p-12 text-center">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
        ...
        <button
          type="submit"
          disabled={busy}
          className="px-8 py-3 bg-yellow-500 text-black font-medium rounded-lg hover:bg-yellow-400 transition-colors hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
        >
