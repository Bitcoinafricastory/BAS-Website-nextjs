    ...
    >
      ...
      <div className="relative md:absolute md:bottom-0 md:left-0 md:right-0 p-5 md:p-10">
        <div className="flex items-center gap-3 mb-3 md:mb-4">
          <span className="text-xs font-medium text-black bg-yellow-500 px-3 py-1.5 rounded-full uppercase tracking-wide">Featured</span>
  ...
  return (
    <Link href={href} className="group flex flex-col bg-[#0A0A0A] border border-white/5 rounded-xl overflow-hidden hover:border-yellow-500 transition-all duration-300">
      <div className="aspect-video overflow-hidden relative bg-gray-800">
        ...
        <span className="absolute top-3 left-3 text-[10px] font-medium text-black bg-yellow-500 px-2.5 py-1 rounded-full uppercase tracking-wide">{post.category}</span>
      </div>
